        ...
        <div class="col-md-12">
          <div class="row navc">
              ...
              <li class="nav-item dropbtn"> <a class="nav-link text-white" href="#">
                Setting
             <div class="dropdown-content">
              <a href="general_setting.html">General setting</a>
              <a href="meta_setting.html">meta setting</a>
              <a href="#">static pages</a>
              <a href="#">payment setting</a>
              <a href="#">payment packs</a>
              <a href="#">Job level setting</a>
              <a href="#">Paypal setting</a>
              <a href="#">cashfree settings</a>
              <a href="#">stripe settings</a>
              <a href="#">payza settings</a>
              <a href="#">referal settings</a>
            </div>
          </div>
          </a>
           </li>
...
<div class="dropdown">
 ...
 <div class="row">
 	<div class="col-md-2">
<p>Days Before Widthdray </p>
<p>Featured Gig Price </p>
<p>Featured Days</p>
<p>Price Mode</p>
<p>Commission Percentage</p>
 	 ...
 	 <div class="col-md-4"> 
      <input type="text" name="" value=" " class=" w-100"> <br/>
 	 <input type="text" name="" value=" " class="mt-4  w-100"> <br/>
 	 <input type="text" name="" value="" class=" mt-2 w-100"> <br/>
 	 <br/>
 	 <select class="w-100">
 	 	<option>
 	 		Price Set by admin(Fixed)
 	 	</option>
 	 	 	 <option>
 	 		Price Set by admin(percentage commission)
 	 	</option>

 	 	 	 <option>
 	 		Price Seller by admin(percentage commission)
 	 	</option>
 	 	
 	 	 	 <option>
 	 		Price Set by Seller(using admin price packs)
 	 	</option>
 	 	
 	 </select >
 	 <input type="text" name="" value="20" class=" mt-2 w-100"> <br/>
  	 </div>
 
 	 <div class="col-md-6">


<p>[NUMBER OF DAYS BEFORE REVENUES FROM GIGS CAN BE WITHDRAWN BY SELLERS]</p>	
<p>[PRICE YOU WANT TO CHARGE USERS TO FEATURE A GIG]	</p>
<p>[NUMBER OF DAYS EACH GIG IS FEATURED FOR AFTER PAYMENT]	</p>
<p>[PRICE MODE FOR GIGS ON THE WEBSITE]	</p>
<p>[PERCENTAGE COMMISSION TO TAKE FROM EACH GIG PURCHASED]</p>	
 
  	</div>
  </div> 

<p>Job levels will be disabled if the price mode is not set to "Price Set by Seller (Using Admin Price Packs)"	
</p>
 <!-- connnte endn -->
  </div>
   </div>
